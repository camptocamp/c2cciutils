...
def pip(package: Dict[str, Any], version: str, version_type: str, publish: bool) -> bool:
    """
    Publish to pypi
...
def docker(
    config: Dict[str, Any], name: str, image_config: Dict[str, Any], tag_src: str, tag_dst: str
) -> bool:
    """
